...
static const float kDurationTime = 0.2;             //-----------------modify by lo-e-----------------
static const float kScaleValue = 0.9;               //-----------------modify by lo-e-----------------
...
//------------------modify by lo-e----------------------
    float scale = (x / 2000) + kScaleValue;//缩放大小
    float alpha = 1 - (x / 200);//透明值
