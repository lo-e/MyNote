...
@property (nonatomic, assign) id <CHTCollectionViewDelegateWaterfallLayout> delegate;
...
- (void)dealloc
{
    ...
    self.sectionItemAttributes = nil;
    self.allItemAttributes = nil;
    self.headersAttribute = nil;
    self.footersAttribute = nil;
    self.unionRects = nil;
    [super dealloc];
}
...
- (NSMutableDictionary *)headersAttribute {
  if (!_headersAttribute) {
    _headersAttribute = [[NSMutableDictionary dictionary] retain];
  }
...
- (NSMutableDictionary *)footersAttribute {
  if (!_footersAttribute) {
    _footersAttribute = [[NSMutableDictionary dictionary] retain];
  }
...
- (NSMutableArray *)unionRects {
  if (!_unionRects) {
      _unionRects = [[NSMutableArray array] retain];
  }
  return _unionRects;
}
...
- (NSMutableArray *)columnHeights {
  if (!_columnHeights) {
      _columnHeights = [[NSMutableArray array] retain];
  }
...
- (NSMutableArray *)allItemAttributes {
  if (!_allItemAttributes) {
    _allItemAttributes = [[NSMutableArray array] retain];
  }
...
- (NSMutableArray *)sectionItemAttributes {
  if (!_sectionItemAttributes) {
    _sectionItemAttributes = [[NSMutableArray array] retain];
  }
